...
In gestordetareas-labels_en.properties:
gestordetareas=My application
gestordetareas[description]=My application does this and that

In gestordetareas-messages_en.properties:
